...
CREATE TABLE "god"."god_users" (
    ...
    "phone_country" VARCHAR(2) NOT NULL DEFAULT 'US',
    "avatar_url" TEXT,
...
CREATE TABLE "god"."god_subscriptions" (
    ...
    "theme_ids" TEXT[],
    "preferred_time" TIME NOT NULL DEFAULT '09:00:00'::time without time zone,
...
-- AddForeignKey
ALTER TABLE "god"."god_chat_conversations" ADD CONSTRAINT "god_chat_conversations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "god"."god_users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "god"."god_chat_messages" ADD CONSTRAINT "god_chat_messages_conversation_id_fkey" FOREIGN KEY ("conversation_id") REFERENCES "god"."god_chat_conversations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
